...
\begin{minipage}[t]{0.85\textwidth}\vspace{0pt}
    ...
    \vspace{0.3cm}
    \topinfo{
        {\emoji{globe-showing-americas} \texttt{Fremont, CA}}
    }
    \topinfo{
...
\end{minipage}
\vspace{-0.1cm} \resumesection{\emoji{briefcase} Experience}
...
\begin{itemize}
    \item
        ...
        \end{itemize}
\end{itemize} \emoji{black-medium-small-square}~~{\color{black}\textbf{ZIZ Defense} \hfill  \textbf{Fremont, CA, USA}}\par
\begin{itemize}
    \item
        \textbf{AI Engineer}
        \hfill  {Nov 2024 -- present} \par
