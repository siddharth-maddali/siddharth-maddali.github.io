\begin{itemize}
    \item \textbf{Science \& Engg.}: Geometric + Fourier optics, ultrasound/acoustics, microscopy, image formation (Hopkins, Abbe), diffraction/scattering, X-ray science, condensed matter + materials physics, electromagnetics, mechanics, statistical physics, semiconductors, experimental design, quantum sciences \par
